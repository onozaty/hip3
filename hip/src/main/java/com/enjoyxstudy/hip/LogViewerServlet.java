...
public class LogViewerServlet extends HttpServlet {
    ...
    public LogViewerServlet(Config config) throws IOException {
        ...
        InputStream inputStream = LogViewerServlet.class
     ...
     * @throws IOException
     */
    private void outputResponce(HttpServletResponse response, String html)
            throws IOException {
    ...
    private String createIndexHTML() {
        ...
        return template.replaceAll("\\$\\{nick\\}", config.getNick())
                .replaceAll("\\$\\{channel\\}", config.getChannel())
                .replaceAll("\\$\\{server\\}", config.getServerName())
                .replaceAll("\\$\\{contents\\}", contents.toString());
    }
    ...
    private String createLogHTML(String date) throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream(new File(config
                .getOutputDir(), date + ".log"));
        try {
